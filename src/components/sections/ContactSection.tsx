...
export const ContactSection = () => {
  ...
  return (
    <section id="contact" className="scroll-mt-14 py-16">
      <div className="mx-auto max-w-5xl px-4">
        ...
        <div ref={bodyRef} className={`max-w-2xl ${bodyClass}`} style={bodyStyle}>
          <p className="mb-2 text-xl font-semibold text-gray-900 dark:text-slate-100">
            {t.contact.subtitle}
          </p>
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center">
            <div className="flex items-center gap-2">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-blue-500 px-5 py-2.5 text-sm font-semibold text-white transition-colors duration-200 hover:bg-blue-400"
              >
                <svg
                  width="16"
                  height="16"
              ...
              <button
                ...
                className="rounded-lg border border-gray-200 px-3 py-2.5 text-sm text-gray-600 transition-colors duration-200 hover:border-blue-500 hover:text-blue-500 dark:border-slate-700 dark:text-slate-400 dark:hover:border-blue-400 dark:hover:text-blue-400"
              >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-gray-200 px-5 py-2.5 text-sm font-semibold text-gray-700 transition-colors duration-200 hover:border-blue-500 hover:text-blue-500 dark:border-slate-700 dark:text-slate-300 dark:hover:border-blue-400 dark:hover:text-blue-400"
            >
              <svg
                role="img"
                aria-label="GitHub"
